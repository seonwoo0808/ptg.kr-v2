...
export default function EditorPage() {
  ...
  const [markdown, setMarkdown] = useState("# Editor Preview\n\nThis is a preview of the editor page.\n\nYou can edit this content in the editor on the right side asdfasdfsafdsdfasdfsadf");

  useEffect(() => {
    const savedData = JSON.parse(localStorage.getItem('editorData') || '{}');
    setTitle(savedData.title || "Lorem ipsum dolor sit amet, consectetur adipiscing elit.");
    setDescription(savedData.description || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
    setCreatedDate(savedData.createdDate ? new Date(savedData.createdDate) : new Date());
    setMarkdown(savedData.markdown || "# Editor Preview\n\nThis is a preview of the editor page.\n\nYou can edit this content in the editor on the right side asdfasdfsafdsdfasdfsadf");
  }, []);
  ...
  return (
      ...
      <div className="flex h-screen">
          ...
          <div className="fixed right-0 top-0 overflow-scroll">

              <div className="w-full flex">
                <h1 className="text-3xl font-bold p-4">Editor</h1>
                <a
                  href="/editor/login"
                  className="ml-auto mr-4 mt-4 inline-flex items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
